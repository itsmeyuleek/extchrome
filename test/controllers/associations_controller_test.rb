...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post associations_url, params: { association: { input_word: @association.input_word, words: @association.words } }
    end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { input_word: @association.input_word, words: @association.words } }
